...
(function(w, n, s) {
  ...
  s.showVideo = function (s){
    s.showModal({type:"text",title:"How to use the Member Shop App",body:'<video style="display:block; margin:0 auto; martin-top:15px" height="100%" controls><source src="https://s3-us-west-2.amazonaws.com/briankranson/video/how_to_use_member_shop_app.mp4" type="video/mp4">Your browser does not support the video tag.</video>'});
  }
